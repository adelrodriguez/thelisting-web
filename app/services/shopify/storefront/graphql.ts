...
export type GetLocalizationQuery = {
  ...
  localization: {
    ...
    country: {
      __typename?: "Country"
      currency: { __typename?: "Currency"; isoCode: CurrencyCode; symbol: string }
    }
  }
}
      ...
      variableDefinitions: [
        {
          ...
          type: {
            kind: "NonNullType",
            type: { kind: "NamedType", name: { kind: "Name", value: "CheckoutCreateInput" } },
          },
        },
      ],
      selectionSet: {
...
export const GetLocalizationDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "getLocalization" },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          {
              ...
              selections: [
                {
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      ...
                      { kind: "Field", name: { kind: "Name", value: "endonymName" } },
                    ],
                  },
                },
                {
...
} as unknown as DocumentNode<GetLocalizationQuery, GetLocalizationQueryVariables>
