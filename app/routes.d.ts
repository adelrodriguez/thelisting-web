declare module "routes-gen" {
  ...
  export function route<
    T extends
      ...
      | [
          "/:listingPath/registry/cart/checkout",
          RouteParams["/:listingPath/registry/cart/checkout"],
        ]
      ...
      | [
          "/api/admin/listings/:listingId/report.csv",
          RouteParams["/api/admin/listings/:listingId/report.csv"],
        ]
      | ["/api/cart"]
      ...
      | [
          "/dashboard/listings/:listingSku/details",
          RouteParams["/dashboard/listings/:listingSku/details"],
        ]
      | [
          "/dashboard/listings/:listingSku/details/edit",
          RouteParams["/dashboard/listings/:listingSku/details/edit"],
        ]
      | [
          "/dashboard/listings/:listingSku/items",
          RouteParams["/dashboard/listings/:listingSku/items"],
        ]
      | [
          "/dashboard/listings/:listingSku/items/:itemSku",
          RouteParams["/dashboard/listings/:listingSku/items/:itemSku"],
        ]
      | [
          "/dashboard/listings/:listingSku/items/:itemSku/cache",
          RouteParams["/dashboard/listings/:listingSku/items/:itemSku/cache"],
        ]
      | [
          "/dashboard/listings/:listingSku/items/:itemSku/delete",
          RouteParams["/dashboard/listings/:listingSku/items/:itemSku/delete"],
        ]
      | [
          "/dashboard/listings/:listingSku/items/new",
          RouteParams["/dashboard/listings/:listingSku/items/new"],
        ]
      | [
          "/dashboard/listings/:listingSku/ribbons",
          RouteParams["/dashboard/listings/:listingSku/ribbons"],
        ]
      | [
          "/dashboard/listings/:listingSku/ribbons/:ribbonId",
          RouteParams["/dashboard/listings/:listingSku/ribbons/:ribbonId"],
        ]
      | [
          "/dashboard/listings/:listingSku/ribbons/new",
          RouteParams["/dashboard/listings/:listingSku/ribbons/new"],
        ]
      | [
          "/dashboard/listings/:listingSku/stats",
          RouteParams["/dashboard/listings/:listingSku/stats"],
        ]
