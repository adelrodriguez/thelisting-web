declare module "routes-gen" {
  ...
  export function route<
    T extends
      ...
      | ["/about"]
      | [
          "/api/admin/listings/:listing/report.csv",
          RouteParams["/api/admin/listings/:listing/report.csv"],
        ]
      | ["/api/cart"]
      ...
      | [
          ...
          RouteParams["/dashboard/admin/users/:userId"],
        ]
      | ["/dashboard/admin/users/new"]
      | ["/dashboard/admin/whatsapp-broadcast"]
      | ["/dashboard/listings"]
      | [
          "/dashboard/listings/:listingSku",
          RouteParams["/dashboard/listings/:listingSku"],
        ]
      | [
          "/dashboard/listings/:listingSku/edit",
          RouteParams["/dashboard/listings/:listingSku/edit"],
        ]
      | [
